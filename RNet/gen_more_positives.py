...
def main():
        ...
        for bbox in bboxes:
            ...
            for i in range(30):
                ...
                if iou > 0.65:# and found_positive == False:
                    ...
                    # Crop out the window and resize if necessary
                    pos_images.append(crop_and_resize_v2(img, window, 24))
    ...
    np.save(args.output_directory + '/pos_images_rnet.npy', np.asarray(pos_images))

    # Save the bounding box annotations
    # np.save(args.output_directory + '/part_faces.npy', np.asarray(par_bboxes))
    np.save(args.output_directory + '/positives_rnet.npy', np.asarray(pos_bboxes))
