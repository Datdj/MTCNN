...
def pnet():
    ...
    padded_output_1 = Lambda(function=pad_0(num_neurons=2), name='padded_output_1')(output_1)
    output_2 = Conv2D(filters=4, kernel_size=(1, 1), kernel_initializer='lecun_normal', name='output_2')(prelu_3)
    padded_output_2 = Lambda(function=pad_0(num_neurons=4), name='padded_output_2')(output_2)
    output_3 = Conv2D(filters=10, kernel_size=(1, 1), kernel_initializer='lecun_normal', name='output_3')(prelu_3)
    padded_output_3 = Lambda(function=pad_0(num_neurons=10), name='padded_output_3')(output_3)
